...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                // COMPLETED (4): Create a variable called emojiBitmap to hold the appropriate Emoji
                ...
                // COMPLETED (8): Call addBitmapToFace(), passing in the resultBitmap, the emojiBitmap
    ...
    // the Emoji bitmap, and a Face object as arguments and returns the combined bitmap with
    // the Emoji over the face.
