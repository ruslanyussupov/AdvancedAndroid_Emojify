...
class Emojifier {
    ...
    private static void whichEmoji(Face face){
        ...
        // COMPLETED (4): Create 3 boolean variables to track the state of the facial expression based
        ...
        Log.v(LOG_TAG, "whichEmoji: " + emoji.name());
    ...
    private enum Emoji {
        ...
        SMILING, FROWNING, LEFT_WINK, RIGHT_WINK, LEFT_WINK_FROWNING,
        RIGHT_WINK_FROWNING, CLOSED_EYE_SMILING, CLOSED_EYE_FROWNING;
